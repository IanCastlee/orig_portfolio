      ...
      <div className="container">
        <div className="line">
          <div className="section">
            ...
            <span>{`Completed my OJT at DevOpt as a Website Designer. Now preparing to seek job opportunities in companies that align with my skills.`}</span>
          </div>
          <div className="section">
            <button className="year">2024</button>
            <span>{`Working on my capstone project while also taking on commission work from fellow students (Node.JS, PHP, MySQL, ReactJS, SCSS).`}</span>
          </div>
          <div className="section" id="stack">
            <button className="year">2023</button>
            <span>{`Started my web development journey and took on web development commissions using Laravel,MySQL, and  CSS.`}</span>
          </div>
          <div className="section">
